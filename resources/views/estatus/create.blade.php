...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8 mt-5">
            <div class="card">
                <h5 class="card-header">Crear nueva estatus</h5>

                <div class="card-body">
                    <form action="{{route("estatus.index")}}" method="post">
                        @csrf
                        <div class="form-group">
                            ...
                            @enderror
                            <small id="nombreHelp" class="form-text text-muted">Indica el nombre del estatus.</small>
                        ...
                        <div class="form-group">
                            ...
                            <small id="descripcionHelp" class="form-text text-muted">Indica la descripción de la estatus.</small>
                        </div>
